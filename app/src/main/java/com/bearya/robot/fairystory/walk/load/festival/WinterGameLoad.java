...
public class WinterGameLoad extends EquipmentLoad {

    public static final int START_OID = 34500;//启动点码
    public static final String NAME = "冬至的游戏";

    public WinterGameLoad() {
        super(START_OID);
    }
    ...
    protected PlayData onNewLoadPlayData() {
        return CodeUtils.oneOf(
                new PlayData(MusicResource.BASE_FESTIVAL_EQUIPMENT_PATH + "玩九九消寒图.mp3", new FacePlay(PictureResource.BASE_FESTIVAL_EQUIPMENT_PATH + "玩九九消寒图.webp", FaceType.Image))
        );
    }
