...
public class TombSweepRiceBallLoad extends EquipmentLoad {

    public static final int START_OID = 10900;//启动点码
    public static final String NAME = "清明的美食";

    public TombSweepRiceBallLoad() {
        super(START_OID);
    }
    ...
    protected PlayData onNewLoadPlayData() {
        return CodeUtils.oneOf(
                new PlayData(MusicResource.BASE_FESTIVAL_EQUIPMENT_PATH + "润饼菜.mp3", new FacePlay(PictureResource.BASE_FESTIVAL_EQUIPMENT_PATH + "润饼菜.webp", FaceType.Image)),
                new PlayData(MusicResource.BASE_FESTIVAL_EQUIPMENT_PATH + "青团.mp3", new FacePlay(PictureResource.BASE_FESTIVAL_EQUIPMENT_PATH + "青团.webp", FaceType.Image))
        );
    }
