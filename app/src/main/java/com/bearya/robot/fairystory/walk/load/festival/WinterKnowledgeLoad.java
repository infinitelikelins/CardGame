...
public class WinterKnowledgeLoad extends EquipmentLoad {

    public static final int START_OID = 32700;//启动点码
    public static final String NAME = "冬至知多少";

    public WinterKnowledgeLoad() {
        super(START_OID);
    }
    ...
    protected PlayData onNewLoadPlayData() {
        return CodeUtils.oneOf(
                new PlayData(MusicResource.BASE_FESTIVAL_EQUIPMENT_PATH + "冬至介绍.mp3", new FacePlay(PictureResource.BASE_FESTIVAL_EQUIPMENT_PATH + "冬至介绍.webp", FaceType.Image))
        );
    }
